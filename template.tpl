...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Merkle Survey - Event Push",
  ...
  "description": "The Merkle Survey Event Push tag allows you enforce a certain behaviour to the Merkle Survey through an event, for example show or hide the survey modal.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    ...
    "defaultValue": "_ocs",
    "help": "You need to go into Template \u003e Permissions and note down then name of the dataLayer name as key in Global Variables, if it\u0027s not the default value _ocs.",
  ...
  },
  {
    ...
    "simpleValueType": true,
    "alwaysInSummary": true,
    "help": "Event that should be pushed to the survey, to enforce a certain behaviour."
  }
]
...
const dataLayerPush = createQueue(dataLayer, data.gtmOnSuccess, data.gtmOnFailure);
